...
template <typename T> inline T TVec3<T>::dot(const TVec3<T> &a) const {
	return (x * a.x + y * a.y + z * a.z);
}

template <typename T> inline T TVec3<T>::length() const {
...
template <typename T> inline TVec3<T> TVec3<T>::normalize(T desired_length) {
	(void)desired_length;
...
template <typename T> inline TVec3<T> TVec3<T>::normalize(TVec3<T> a) {
	return a.normalize();
}
